...
All the equations above share the characteristic that they equate two separate values $y$ and $x$ through the equal sign "$=$".
The equation assert an equality between to distinct values $y$ and $x$.

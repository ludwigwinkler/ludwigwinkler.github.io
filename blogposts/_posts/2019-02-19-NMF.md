...
Here we're using an exponential distribution with a larger $\lambda$ to initialize $P, Q, u, i, b$ such that their values are small and positive.
...
For a Bayesian version that quantifies uncertainty over recommendations using the reparameterization trick, see [Bayesian Non-Negative Matrix Factorization](https://ludwigwinkler.github.io/blog/BayesNMF/).
